...
**How it works:**
* **Bluetooth SPP Transport:** The app sends mouse signals over Bluetooth Serial (SPP). This replaces the WiFi/UDP architecture.
...
* **Background Behavior:** The app does not require persistent background/foreground services. Unnecessary services have been removed.

### 4. System Requirements
* **Minimum SDK:** 28.
* **Permissions:** Removed WiFi permissions. Added Bluetooth permissions (`BLUETOOTH_SCAN`, `BLUETOOTH_CONNECT`, etc.).
